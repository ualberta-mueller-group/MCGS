...
void zero4()
{
    ...
    assert(cgt_move_new::move2_get_from(m1) == 0);
    assert(cgt_move_new::move2_get_to(m1) == 1);

    const move m2 = mg2->gen_move();
    assert(cgt_move_new::move2_get_from(m2) == 13);
    assert(cgt_move_new::move2_get_to(m2) == 12);
}
...
void simple1()
{
    ...
    {
        vec.push_back(cgt_move_new::move2_create(from, to));
    };
...
void manual1()
{
    ...
    pos.play(cgt_move_new::move2_create(3, 4), BLACK);
    assert(pos.board_as_string() == "X...XX.O.OO.XX.O");
    pos.play(cgt_move_new::move2_create(7, 6), WHITE);
...
void undo1()
{
    ...
    pos.play(cgt_move_new::move2_create(1, 2), BLACK);
    assert(pos.board_as_string() == "..XO.X..O.O");

    pos.play(cgt_move_new::move2_create(10, 9), WHITE);
...
void undo2()
{
    ...
    pos.play(cgt_move_new::move2_create(1, 0), WHITE);
    assert(pos.board_as_string() == "O.O.X.O.XOX..O..X.X");
    pos.play(cgt_move_new::move2_create(2, 1), WHITE);
