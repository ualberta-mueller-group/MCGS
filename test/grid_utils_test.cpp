...
void test_empties()
{
    ...
    for (const test_case_t& test_case : test_cases)
    {
        ...
        assert(grid_generator::get_empty_board(r, c) == exp);
    }
}
...
void grid_utils_test_all()
{
    ...
    grid_location_test::test_conversion();

    grid_generator_test::test_1x2();
    grid_generator_test::test_2x1();
    grid_generator_test::test_2x2();
    grid_generator_test::test_empties();
}
