...
{
    assert_player_sum_outcome_impl(player, expected_outcome, games, delete_games);
}

void assert_player_sum_outcome_impl(int player, bool expected_outcome, std::vector<game*>& games, bool delete_games)
{
...
void assert_sum_outcomes_impl(bool black_outcome, bool white_outcome, std::vector<game*>& games)
{

    assert_player_sum_outcome_impl(BLACK, black_outcome, games, false);
    assert_player_sum_outcome_impl(WHITE, white_outcome, games, true);
}


void assert_sum_outcomes(bool black_outcome, bool white_outcome, vector<game*> games)
{
    assert_sum_outcomes_impl(black_outcome, white_outcome, games);
}
