/*
    The move generator currently in this file used to be located at
    `src/sheep_alt_generator.h`. The move generator which used to be in this
    file was unused, and is now located in src/old_code`.
*/
#include "sheep.h"
...
void sheep::play(const ::move& m, bw to_play)
{
    ...
    int point_start;
    int point_end;
    cgt_move::move3_unpack(m, target_herd, point_start, point_end);
...
void sheep::undo_move()
{
    ...
    int point_start;
    int point_end;
    cgt_move::move3_unpack(m_enc, target_herd, point_start, point_end);
...
dyn_serializable* sheep::load_impl(i_ibuffer& is, serializer_ctx* ctx)
{
...
void sheep::print_move(std::ostream& str, const ::move& m, ebw to_play) const
{
    ...
    int from_point;
    int to_point;
    cgt_move::move3_unpack(m, target_herd, from_point, to_point);
