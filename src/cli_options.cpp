...
void print_help_message(const string& exec_name)
{
    ...
    print_flag(
        "--print-subgame-moves",
        "For each subgame in the sum, print the moves for each player (in "
        "the same order that they are generated by the subgame's "
        "move_generator)");

    print_flag("--print-sum-moves", "Print each player's moves in the sum as "
                                    "generated by the sumgame_move_generator");
